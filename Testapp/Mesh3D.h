...
public:
	...
	static void LoadFromNoise(std::string _name, int _size, float _xScale, float _yScale);
...
private:
	...
	Terrain3D(std::string _name, int _size, float _xScale, float _yScale, bool _fromFile = true);
	int DrawType;
